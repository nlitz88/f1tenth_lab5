...
def generate_path_from_file(filepath: str, stamp: Time, frame_id: Optional[str] = "map") -> Path:
    ...
    Args:
        ...
        waypoints.
        stamp (Time): Timestamp that will be applied to the path and PoseStamped
        poses within the path.
